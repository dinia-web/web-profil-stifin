  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-left">
        <img src="/themes/medicio/assets/img/slide/slide-1.jpg" alt="Gambar STIFIn" class="img-fluid" style="max-height: 270px;">
      </div>
    </div>
  </div>
</section><!-- End Hero -->
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6" data-aos="fade-right">
            <img src="/themes/Medicio/assets/img/whych.png" class="img-fluid" alt="" style="max-height: 380px;">
          </div>
